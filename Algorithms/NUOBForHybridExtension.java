...
public class NUOBForHybridExtension extends OzaBag {
    ...
    NUOBForHybridExtension(int windowSize,
    ...
    public String getPurposeString() {
        return "Neighbourhood undersampling online bagging - part of hybrid extension algorithm";
    }
    ...
    public double calculatePoissonLambda(Instance inst) {
        ...
        if ((int) inst.classValue() != minClass) {
            ...
            return betaCoefficient * Math.pow(safeLevelOfInstance, psiCoefficient);
        }
